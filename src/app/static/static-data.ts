...
//
  static TimeZones: TimeZone[] = [
    {value: -12, name: '(UTC-12:00) Линия перемены дат'},
    {value: -11, name: '(UTC-11:00) Время в формате UTC-11'},
    {value: -10, name: '(UTC-10:00) Гавайи'},
    {value: -9, name: '(UTC-9:00) Аляска'},
    {value: -8, name: '(UTC-8:00) Нижняя Калифорния'},
    {value: -7, name: '(UTC-7:00) Аризона'},
    {value: -6, name: '(UTC-6:00) Центральная Америка'},
    {value: -5, name: '(UTC-5:00) Восточное время (США и Канада)'},
    {value: -4, name: '(UTC-4:00) Атлантическое время (Канада)'},
    {value: -3, name: '(UTC-3:00) Бразилия'},
    {value: -2, name: '(UTC-2:00) Время в формате UTC-02'},
    {value: -1, name: '(UTC-1:00) Азорские острова'},
    {value: 0, name: '(UTC+0:00) Дублин, Эдинбург, Лиссабон, Лондон'},
    {value: 1, name: '(UTC+1:00) Варшава, Загреб, Сараево, Скопье'},
    {value: 2, name: '(UTC+2:00) Вильнюс, Киев, Рига, София, Таллин, Хельсинки'},
    {value: 3, name: '(UTC+3:00) Москва, Санкт-Петербург, Волгоград'},
    {value: 4, name: '(UTC+4:00) Ижевск, Самара'},
    {value: 5, name: '(UTC+5:00) Екатеринбург'},
    {value: 6, name: '(UTC+6:00) Астана'},
    {value: 7, name: '(UTC+7:00) Красноярск'},
    {value: 8, name: '(UTC+8:00) Иркутск'},
    {value: 9, name: '(UTC+9:00) Якутск'},
    {value: 10, name: '(UTC+10:00) Владивосток'},
    {value: 11, name: '(UTC+11:00) Магадан'},
    {value: 12, name: '(UTC+12:00) Анадырь, Петропавловск-Камчатский'}
  ];
